...
const Home = () => {
    ...
    <div class="row flex-lg-row-reverse align-items-center g-5">
      <div class="col-10 col-sm-8 col-lg-6">
        ...
        <img src= {img_2} class="d-block mx-lg-auto img-fluid custom_img"  alt="Bootstrap Themes" loading="lazy"/> 
      </div>
      <div class="col-lg-6">
...
<div class="container px-4 py-5" id="hanging-icons">
    <h1 class="pb-2 border-bottom fw-bold text-center">Some of our Features</h1>
